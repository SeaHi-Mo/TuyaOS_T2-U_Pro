...
VOID_T app_key_init(TUYA_GPIO_NUM_E pin_id)
{
    ...
    TAL_PR_DEBUG("app_key_init pin_id:%d", pin_id);
    TUYA_CALL_ERR_LOG(tkl_gpio_init(pin_id, &key_cfg));
    sg_key_pin_id = pin_id;
    TAL_PR_DEBUG("tkl_gpio_init pin_id:%d", pin_id);
    /* start key thread */
    ...
    TAL_PR_DEBUG("tal_thread_create_and_start pin_id:%d", pin_id);
    TUYA_CALL_ERR_LOG(tal_thread_create_and_start(&key_task_handle, NULL, NULL, app_key_task, NULL, &thread_cfg));
    TAL_PR_DEBUG("tal_thread_create_and_start end pin_id:%d", pin_id);

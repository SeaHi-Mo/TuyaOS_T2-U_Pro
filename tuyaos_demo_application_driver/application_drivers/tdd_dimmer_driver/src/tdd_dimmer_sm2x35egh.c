 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
STATIC OPERATE_RET __tdd_dimmer_sm2x35egh_config(IN DIMMER_DRV_HANDLE drv_handle, DIMMER_DRV_CMD_E cmd, VOID_T *arg)
{
    DIMMER_SM2X35EGH_DRV_T *p_drv = (DIMMER_SM2X35EGH_DRV_T *)drv_handle;
 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
STATIC OPERATE_RET __tdd_dimmer_sm2x35egh_register(CHAR_T *name, TDD_I2C_PIN_T *p_i2c,\
                                                   DIMMER_CH_CFG_U *p_ch_cfg, SM2X35EGH_CFG_T *p_chip_cfg, DIMMER_CHIP_TYPE_E tp)
{
 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
OPERATE_RET tdd_dimmer_sm2235egh_register(CHAR_T *name, TDD_I2C_PIN_T *p_i2c,\
                                         DIMMER_CH_CFG_U *p_ch_cfg, SM2X35EGH_CFG_T *p_chip_cfg)
{
    return __tdd_dimmer_sm2x35egh_register(name, p_i2c, p_ch_cfg, p_chip_cfg, DIMMER_CHIP_SM2235EGH);
}

/**
 * @brief register SM2335EGH dimmer
 *
 * @param[in] name: dimmer name
 * @param[in] p_i2c: i2c pin config
 * @param[in] p_ch_cfg: color channel id config
 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
OPERATE_RET tdd_dimmer_sm2335egh_register(CHAR_T *name, TDD_I2C_PIN_T *p_i2c,\
                                          DIMMER_CH_CFG_U *p_ch_cfg, SM2X35EGH_CFG_T *p_chip_cfg)
{
    return __tdd_dimmer_sm2x35egh_register(name, p_i2c, p_ch_cfg, p_chip_cfg, DIMMER_CHIP_SM2335EGH);
}

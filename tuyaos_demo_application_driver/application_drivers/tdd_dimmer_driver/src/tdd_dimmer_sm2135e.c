 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
STATIC OPERATE_RET __tdd_dimmer_sm2135e_config(IN DIMMER_DRV_HANDLE drv_handle, DIMMER_DRV_CMD_E cmd, VOID_T *arg)
{
    DIMMER_SM2135E_DRV_T *p_drv = (DIMMER_SM2135E_DRV_T *)drv_handle;
                                        ...
                                        DIMMER_CH_CFG_U *p_ch_cfg, SM2135E_CFG_T *p_chip_cfg)
{
    ...
    drv_info.chip_tp    = DIMMER_CHIP_SM2135E;
    drv_info.resolution = SM2135E_GRAY_VAL_MAX; 

    intfs.open   = __tdd_dimmer_sm2135e_open;
    intfs.close  = __tdd_dimmer_sm2135e_close;
    intfs.output = __tdd_dimmer_sm2135e_output;
    intfs.config = __tdd_dimmer_sm2135e_config;

 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
STATIC OPERATE_RET __tdd_dimmer_bp1658cj_config(IN DIMMER_DRV_HANDLE drv_handle, DIMMER_DRV_CMD_E cmd, VOID_T *arg)
{
    DIMMER_BP1658CJ_DRV_T *p_drv = (DIMMER_BP1658CJ_DRV_T *)drv_handle;
                                         ...
                                         DIMMER_CH_CFG_U *p_ch_cfg, BP1658CJ_CFG_T *p_chip_cfg)
{
    ...
    drv_info.chip_tp    = DIMMER_CHIP_BP1658CJ;
    drv_info.resolution = BP1658CJ_GRAY_VAL_MAX; 

    intfs.open   = __tdd_dimmer_bp1658cj_open;
    intfs.close  = __tdd_dimmer_bp1658cj_close;
    intfs.output = __tdd_dimmer_bp1658cj_output;
    intfs.config = __tdd_dimmer_bp1658cj_config;

 ...
 * @return OPRT_OK on success. Others on error, please refer to "tuya_error_code.h"
 */
STATIC OPERATE_RET __tdd_dimmer_bp5758d_config(IN DIMMER_DRV_HANDLE drv_handle, DIMMER_DRV_CMD_E cmd, VOID_T *arg)
{
    DIMMER_BP5758D_DRV_T *p_drv = (DIMMER_BP5758D_DRV_T *)drv_handle;
                                        ...
                                        DIMMER_CH_CFG_U *p_ch_cfg, BP5758D_CFG_T *p_chip_cfg)
{
    ...
    drv_info.chip_tp    = DIMMER_CHIP_BP5758D;
    drv_info.resolution = BP5758D_GRAY_VAL_MAX; 

    intfs.open   = __tdd_dimmer_bp5758d_open;
    intfs.close  = __tdd_dimmer_bp5758d_close;
    intfs.output = __tdd_dimmer_bp5758d_output;
    intfs.config = __tdd_dimmer_bp5758d_config;

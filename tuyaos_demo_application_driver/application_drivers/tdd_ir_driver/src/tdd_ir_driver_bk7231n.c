/**
 * @file tdd_ir_driver_bk7231n.c
 * @author www.tuya.com
 * @brief tdd_ir_driver_bk7231n module is used to 
 * @version 0.2
 * @date 2022-06-07
 *
...
#define IR_SEND_INTER_CODE_DELAY    (300*1000) // unit: us, default: 300ms
...
static void __tdd_bk7231n_32k_enable(BK7231N_REG_T *reg_val)
{
...
static void __tdd_bk7231n_32k_disable(BK7231N_REG_T *reg_val)
{
    if (0 == reg_val->val_32k) {
...
static int __tdd_ir_send_start(IR_DRV_INFO_T *drv_info)
{
    ...
    rt = __tdd_ir_pwm_start(drv_info->send_pwm_id, IR_SEND_FREQ_DEFAULT, 0);
    if (OPRT_OK != rt) {
        return rt;
    }
...
static int __tdd_ir_pre_send_process(IR_DRV_HANDLE_T drv_hdl)
{
    ...
    /* close fiq */
    __tdd_bk7231n_fiq_disable();
    __tdd_bk7231n_32k_disable(&reg_val);
...
static int __tdd_ir_send_finish_process(IR_DRV_HANDLE_T drv_hdl)
{
    ...
    /* open fiq, irq */
    __tdd_bk7231n_fiq_enable();
    __tdd_bk7231n_32k_enable(&reg_val);

 ...
 * @return none
 */
STATIC VOID_T __sht3x_read_data(IN CONST SR_RSRC_T *dev, IN CONST USHORT_T len, OUT UCHAR_T *data)
{
    SR_I2C_MSG_T rd_msg = {
 ...
 * @return none
 */
STATIC VOID_T __sht3x_write_cmd(IN CONST SR_RSRC_T *dev, IN CONST SHT3X_CMD_E cmd)
{
    UCHAR_T cmd_bytes[2];
